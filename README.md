...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ipyslides-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14097&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ipyslides-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ipyslides` can be installed with:

```
conda install ipyslides
```

It is possible to list all of the versions of `ipyslides` available on your platform with:
